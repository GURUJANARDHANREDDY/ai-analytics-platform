...
class Settings:
    ...
    hf_api_token: str = field(default_factory=lambda: os.getenv("HF_API_TOKEN", "").strip())
    hf_model: str = field(default_factory=lambda: os.getenv("HF_MODEL", "mistralai/Mistral-7B-Instruct-v0.3").strip())
